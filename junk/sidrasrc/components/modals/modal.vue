          ...
          <nav>
            <ul class="nav">
              ...
              <li class="nav-link" style="padding-bottom:0px" id="draw" exact>
                <a style="font-size:12px" @click="display=2">Draw</a>
              </li>
              <li class="nav-link" style="padding-bottom:0px" id="upload" exact>
                <a style="font-size:12px" @click="display=3">Upload</a>
              </li>
            </ul>
          </nav>
