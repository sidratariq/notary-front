  ...
  <div class="setborder">
    ...
    <div class="sethidden topset" style="padding-top:18px" v-if="flag">
      <div class="row">
        ...
        <div class="col-1">
          <button class="btn btn-sm apply" type="button">Restore</button>
        </div>

        <div class="btn-group" style="padding-right: 0px;padding-left: 8px;">
          <button
            class="btn btn-sm dropdown-toggle apply"
            style="height:30px;padding-left: 8px; margin-top:0px"
            type="button"
...
export default {
  ...
  props: ["checked", "nooffilesselected"],
  ...
  computed: {
    ...
    searchvalue: function() {
      ...
      if (
        this.$route.query.view == "Actions Required" ||
        this.$route.query.view == "Waiting for Others" ||
        this.$route.query.view == "Expiring Soon" ||
        this.$route.query.view == "Completed"
      ) {
