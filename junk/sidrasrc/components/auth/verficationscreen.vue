    ...
    <div class="row">
      ...
      <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-center">
        <transition name="fade">
          <div
            v-if="show"
            class="alert alert-info okay"
            transition="expand"
          >Account created sucessfully</div>
        </transition>


         <transition name="fade">
          <div
            v-if="resendcode==true"
            class="alert alert-info okay"
            transition="expand"
          >Verification code was send to {{email}}. Please Check your email.</div>
        </transition>
        ...
        <p>
          Please enter the verification code sent at {{email}}
          <br>
        </p>
        ...
        <div>
          <button class="btn btn-link" @click="sendcode">Resend Code</button>
        </div>
      </div>
