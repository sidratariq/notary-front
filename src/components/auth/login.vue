...
<div>
            <form>
                    ...
                    <div class="form-group" > 
                          <input type="email" v-model="email" class="form-control" @input="$v.email.$touch()" style="width:90%" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                    ...
                    <button class="bbutton btn-width" :class="{disabled:$v.email.$invalid}"  @click.prevent="clickhappened()">Continue</button>

            </form>

                 <button class="btn btn-link"   @click="signup" ><small>No account? Sign up for free</small></button>
