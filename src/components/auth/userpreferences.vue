      <template>
    <div class="row mx-0">
      <div class="signatures-preferences container" style="padding-top:30px">
        <!-- // changes -->
        ...
        <div class="grid section">
          <div class="row">
            <!-- @click="getclick" -->
            <div class="col-md-12 col-lg-12 removepadding">
              <div class="col-md-6">
                <div class="row">
    ...
    padding-left: 34px;">
                    ...
                    <div class="row">
                      ...
                      <p style="padding-left:23px">{{username[0]}}</p>
                      <button
                        class="btn btn-link"
                        style="display:inline;padding-bottom: 0px;padding-top: 0px; min-width:50px; margin-bottom:15px"
                        data-toggle="modal"
                    ...
                    <div class="row">
                      ...
                      <p style="padding-left:23px">{{username[1]}}</p>
                      <button
                        class="btn btn-link"
                        style="display:inline;padding-bottom: 0px;padding-top: 0px; min-width:50px; margin-bottom:15px"
                        data-toggle="modal"
              ...
              <div class="col-md-6" style="padding-left:20px">
                ...
                <div class="btn-group" style="height:30px; margin-top:5px">
                  <button type="button" class="btn btn-primary" style="font-size:12px; min-width:50px;padding-top:5px">Edit</button>
                  <button
                    type="button"
                    class="btn btn-primary btn-trigger dropdown-toggle "
                    data-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                    style="padding-left:5px; padding-right:5px; border-left:0.5px solid #ccc; height:30px"
                  >
          ...
          <div class="col-2-5">
            ...
            <div class="form-group" style="padding-left:0px; width:60%">
              ...
              <input
                ...
                id="phone"
                data-kwimpalastatus="alive"
                data-kwimpalaid="1551144858268-33" style="height:35px"
              >
            </div>
          </div>
        </div>
        ...
        <div class="grid">
          ...
          <div class="col-2-5">
            ...
            <div class="form-group" style="padding-left:0px; width:60%">
              <label class="label" for="phone">
                Phone
                <span class="text-muted" data-children-count="0"><small class="text-muted">(optional)</small></span>
              </label>
              <input
                type="text"
                class="input-text"
        ...
        <div>
        <span>
            <h1 class="header-title" style="display:inline">Update Signature</h1> 
            </span> 
              <small class="text-muted font-weight-normal">(Manage different signature styles and variations of your name.)</small>
        </div>
            ...
            <table class="table sig-table">
              ...
              <tbody>
                <tr data-qa="signature-row">
                  ...
                  <td>
                    <div class="sig-chrome">
                      <span class="sig-chrome-title-top" aria-hidden="true">DS</span>
                      <div class="sig-container">
                        <!-- <img class="sig" alt="S"> -->
                      </div>
                    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group" style="padding-left: 10px; padding-right: 10px;">
              <p>Are you sure you want to update your first name</p>
            </div>
      ...
      <div id="lastname" class="modal fade" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group" style="padding-left: 10px; padding-right: 10px;">
              <p>Are you sure you want updatelastname</p>
            </div>
