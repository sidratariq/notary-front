      <template>
  <div class="row mx-0">
    <div class="signatures-preferences container">
      <!-- // changes -->
          ...
          <div class="col-md-12 col-lg-12 removepadding">
            <div class="col-md-6">
              <div class="row">
                ...
                <div class="col-md-9" style="    padding-top: 75px;  padding-left: 30px;">
                  <div class="row">
                    <span>
                      <!-- email here -->
                      {{email}}
            ...
            <div class="col-md-6" style="padding-left:20px">
              ...
              <div class="btn-group" style="height:30px; margin-top:5px">
                <button
                  ...
                  style="font-size:12px; min-width:50px;padding-top:5px"
                >Edit</button>
                <button
                  type="button"
      ...
      <div class="grid">
        ...
        <div class="col-2-5">
          ...
          <div class="form-group" style="padding-left:0px; width:60%">
            <label class="label" for="phone">
              Phone
              <span class="text-muted" data-children-count="0">
      ...
      <div>
        ...
        >(Manage different signature styles and variations of your name.)</small>
      </div>
                ...
                <td>
                  <div class="sig-cell">
                    <div class="sig-chrome">
                      <span class="sig-chrome-title-top">E-notarized by:</span>

                      <div class="sig-container"></div>
                      <span class="sig-chrome-title-bottom">{{userid}}</span>
                    </div>
                  </div>
                </td>
...
export default {
  ...
  computed: {
    ...
    company:{
      ...
      set(value){
        this.$store.dispatch('changecompany',value)
      }
