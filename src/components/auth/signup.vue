      ...
      <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
        <div>
          ...
          <transition name="fade">
            <div v-if="error!=''" class="alert alert-info okay" transition="expand">
              {{error}}. Please go
              <a href="http://localhost:8080/verify">here</a>
            </div>
          </transition>
            ...
            <div class="row">
              <div class="col-6">
                ...
                <small
                  ...
                  :class="{invalid:!$v.firstname.alpha}"
                >Spaces and numbers are not allowed</small>
              </div>
              <div class="col-6">
                <input
                  type="text"
              ...
              <div class="col-12">
                ...
                >
                <small
                  v-if="!$v.company.minLen"
                  :class="{invalid: !$v.company.minLen}"
                >Company name must be 3 character long</small>
              </div>
              ...
              <div class="col-12">
                ...
                >
                <small
                  v-if="!$v.number.minLen"
                  :class="{invalid:true}"
                >Phone number must be 8 digit long</small>
              </div>
              ...
              <div class="col-12">
                ...
                <small
                  ...
                  :class="{invalid:true}"
                >The password must be 8 character long</small>
              </div>
              ...
              <div class="col-12">
                ...
                >
                <small
                  v-if="!$v.confirmPassword.sameAs && $v.confirmPassword.$invalid"
                  :class="{invalid:true}"
                >The password does not match</small>
              </div>
