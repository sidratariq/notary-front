  ...
  <div class="setbackground">
    <div class="container set-middle padding">
      ...
      <transition name="fade">
        <div v-if="error" class="alert alert-danger w-75 setplace" transition="expand">
      ...
      <transition name="fade">
        <div
          v-if="norecipient"
          class="alert alert-danger w-75 changeplace"
          style="color:#b22b31"
          transition="expand"
        >To continue, add a name and email for each recipient.</div>
      </transition>
      ...
      <div class="setpadding setborder">
        ...
        <div class="col-md-12 col-xs-12 col-lg-12 setrelative">
          ...
          <strong class="sizing to-lower">{{creator}}</strong>
          <span class="setround">
        ...
        <div
          v-for="(key,index) in recipeints"
          style="background-color:#fffff"
          :key="index"
          class="col-md-12 col-lg-12 use-extra foreground"
        >
          <!--  v-rainbow -->
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="dropdown">
                    ...
                    >
                      <i
                        :class="{'fas fa-file-signature seteffect':signclass(index),'far fa-closed-captioning seteffect':copyclass(index)}"
                      ></i>
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                      <button
                        class="dropdown-item seteffect"
                        @click="UserSign(index)"
                        type="button"
                        style="font-size:13px; "
                      >
                        <span>
        ...
        <div class="col-md-12 col-xs-12 col-lg-12 setrelative set-top">
          <p
            class="removemargin to-lower"
            style="font-weight:400; color:#333"
          >Once an envelope has been routed to all recipients, and documents signed, each recipient will get a completed copy.</p>
          <span class="setround">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-6">
                      <button
                        type="button"
                        class="OliveReact-Button--sizeLarge OliveReact-Button--main OliveReact-Button to-upper"
                        @click="oldroute"
...
export default {
  data() {
    return {
      recipeints: [
        {
          cid: this.$store.getters.getcontractid,
          name: "",
          email: "",
          NeedtoSign: true,
          Receiveacopy: false
  ...
  methods: {
    ...
    changeroute() {
      ...
      this.recipeints.forEach(element => {
        validemail.push(Object.values(element)[2]);
        validusername.push(Object.values(element)[1]);
      });
