        ...
        <div class="maindiv">
          <div class="sig-panel first">
            <div class="box">
              ...
              <signature  v-show="showsign"></signature>
            </div>
          </div>
          ...
          <div class="sig-panel second">
            <div class="box">
              ...
              <signature  v-show="showinitial"></signature>
            </div>
          </div>
        </div>
    ...
    export default {
      ...
      methods: {
        ...
        run(event) {
                ...
                if(event.target.name== 'signature'){
                  ...
                  // this.userSignature = dataURL;
                  return this.signatureFlag = true;
                  // console.log("signature show"+this.signatureFlag)
                }
                // che  ck whether user has uploaded initial
                else{
                  // console.log("In dataurl initial");
                  // console.log("Signature log"+dataURL)
                  // this.initialSrc = dataURL;
                  console.log(this.initialFlag + "here 2")
                  this.initialFlag = true;
                  localStorage.setItem('Avalible',this.initialFlag)
                  // this.initialFlag = true;

                //  console.log("initial indie Flag"+this.initialFlag)
                }
              }
      ...
      computed: {
          ...
          showinitial(){
           // console.log("inside show signature"+this.initialFlag)
            return localStorage.getItem('Avalible');
          }
      },
